(function () {
  ...
  style.textContent = `
    ...
    #claude-tc-badge .ctc-label { font-size: 9px; text-transform: uppercase; letter-spacing: 0.08em; color: #52525b; margin-right: 2px; }
    ...
    #claude-tc-detail .ctc-conv       { color: #a1a1aa; font-size: 10px; margin-bottom: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 210px; }
    #claude-tc-detail .ctc-model-name { color: #52525b; font-size: 10px; margin-bottom: 10px; }
    #claude-tc-detail table            { width: 100%; border-collapse: collapse; }
    #claude-tc-detail td               { padding: 1px 0; color: #71717a; }
    #claude-tc-detail td:last-child    { text-align: right; font-weight: 600; }
    #claude-tc-detail .ctc-section-row td { color: #3f3f46; font-size: 9px; text-transform: uppercase; letter-spacing: 0.07em; padding-top: 9px; padding-bottom: 2px; }
    ...
    #claude-tc-detail .ctc-dim     { color: #52525b; }
